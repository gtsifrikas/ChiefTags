...
import UIKit
 ...
 public class ChiefTags: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    private func setUp() {
        ...
        self.collectionView!.registerClass(ChiefTagCollectionViewCell.self, forCellWithReuseIdentifier: "tagCell")
    ...
    private func configureCell(cell: UICollectionViewCell, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cellToConfigure = cell as! ChiefTagCollectionViewCell
...
protocol ChiefTagsViewDelegate {
